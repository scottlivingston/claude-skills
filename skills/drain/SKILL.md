...
Drain the **AFK frontier** of a wayfinder map: every open, unblocked, unclaimed child ticket that an agent can resolve alone. HITL tickets (grilling, prototype, design, human-checklist tasks) are never touched — they belong to a live session with the human.
