...
const AXIS_INPUTS = j([
  ...
  PRIOR_ROUND_SUMMARIES.length
    ? 'Prior-round summaries — answered verdicts recorded here, and any spec comments they posted, are BINDING spec text; a finding one directly governs diverges from the answer, it does not raise a new question:\n' + PRIOR_ROUND_SUMMARIES.join('\n---\n')
    : null,
])
...
function ledgerPrompt(escalations, digest) {
  ...
  return j([
    ...
    '<One or two sentences: what part of the product this concerns and what the change wants there, and what the question is.>\n',
