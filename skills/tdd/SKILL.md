...
- **Refactoring is not part of the loop.** It belongs to the review stage (`/tareview`, whose Standards axis carries the smell baseline), not the red → green implementation cycle.
